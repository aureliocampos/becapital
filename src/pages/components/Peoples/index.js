        ...
        <div className="peoples__grid">
          <article className="peoples__card--primary">
            ...
            <div className="peoples__description">
              <StaticImage src="../../../images/open-quote.png" alt="Ícone de citação"/>
              ...
              <p className="peoples__paragraph">Tudo acontece da forma mais transparente possível. Aqui, você é protagonista da sua carreira em todos os sentidos!</p>
              <h3 className="peoples__name"><strong>Gabriella Alves</strong> | Analista de Recursos Humanos</h3>
            </div>
          </article>
          ...
          <article className="peoples__card--secondary">
            ...
            <div className="peoples__author">
              <StaticImage src="../../../images/foto_renata_mattos.png" alt="Foto de Renata Mattos, Coordenadora de Conteúdo" className="peoples__image--card-primary"/>
              <h3 className="peoples__name"><strong>Renata Mattos</strong><br/> Coordenadora de Conteúdo</h3>
            </div>
          </article>
          </div>
        </div>
